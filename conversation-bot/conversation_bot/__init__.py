...
# Convert previous inpt to text and encode it.
...
def main():
    ...
    parser.add_argument('model_dir', type=str,
                        help='Path to a transfomers model checkpoint. Type help for more info.')
    ...
    gpt2, tokenizer = AutoModelForCausalLM.from_pretrained(
        args.model_dir), AutoModelForCausalLM.from_pretrained('distilgpt2')
    inpt = get_input()
    previous_inpts = [inpt]
